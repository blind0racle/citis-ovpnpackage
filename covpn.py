...
def main():
    ...
    # -a now optionally takes a username: covpn -a username  or covpn -a (interactive)
    ...
    if args.add:
        ...
        # Determine username: if args.add is a string, use it; else None (interactive)
        ...
        if args.batch:
            ...
            # Interactive mode – may have a pre‑supplied username
